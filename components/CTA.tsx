    ...
    <section id="contacto" className="py-16 px-4 sm:px-6 lg:px-8">
      <div className="max-w-4xl mx-auto">
        <div className="cta-section rounded-3xl p-10 sm:p-14 text-center relative overflow-hidden fade-up">
          <div
            className="orb"
            style={{ width: 500, height: 500, background: 'radial-gradient(circle,rgba(217,119,6,0.25),transparent)', top: '50%', left: '50%', transform: 'translate(-50%,-50%)' }}
          />

          <div className="relative z-10">
            <p className="section-label mb-4">Hablemos hoy</p>
            ...
            <p className="text-gray-400 max-w-xl mx-auto mb-10 text-base leading-relaxed">
              Agenda una llamada gratuita de 30 minutos y descubre cómo transformar tu presencia digital con estrategias probadas.
            </p>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <a
                ...
                className="btn-outline text-white px-8 py-4 rounded-full font-semibold text-base cursor-pointer inline-flex items-center justify-center gap-2.5"
              >
            ...
            <p className="text-gray-500 text-sm mt-7">Sin compromiso · Respuesta en menos de 24h</p>
          </div>
        </div>
      </div>
    </section>
